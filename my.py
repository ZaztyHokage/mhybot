...
def phone(message):
    ...
    button_phone = types.KeyboardButton(text='Azo bolish', request_contact=True)
    keyboard.add(button_phone)
    bot.send_message(message.chat.id, 'Davom etish uchun kanalga azo boling', reply_markup=keyboard)
